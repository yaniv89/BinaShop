...
//using BinaShop.WebUI.Tests.Mocks;
...
//            customers.Insert(new Customer() { Id = "1", Email = "yanivabu8@gmail.com", ZipCode = "123456" });

//            IPrincipal FakeUser =new GenericPrincipal(new GenericIdentity("yanivabu8@gmail.com","Forms"),null);
